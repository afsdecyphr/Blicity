            ...
            <div id="content">
                ...
                <div class="center-block" style="text-align: center;">
                    <div class="center-block" style="margin: 0 auto; text-align: center; width: inherit; display: inline-block;">
                        <button class="btn btn-info center-block btn-lg" onclick="updateStatus(1);" style="width:150px;" id="status_1">10-8</button>
                        <button href="#" class="btn btn-info center-block btn-lg" onclick="updateStatus(3);" style="width:150px;" id="status_3">10-15</button>
                        <button href="#" class="btn btn-info center-block btn-lg" onclick="updateStatus(4);" style="width:150px;" id="status_4">10-97</button>
                        <button href="#" class="btn btn-info center-block btn-lg" onclick="updateStatus(5);" style="width:150px;" id="status_5">10-23</button>
                        <button href="#" class="btn btn-info center-block btn-lg" onclick="updateStatus(2);" style="width:150px;" id="status_2">10-6</button>
                        <button href="#" class="btn btn-info center-block btn-lg" onclick="updateStatus(0);" style="width:150px;" id="status_0">10-7</button>
                    </div>
                </div>
                <div style="width: calc(-10px + 75%); float: left; margin: 0 5px;">
                ...
                <div class="center-block" style="text-align: center;width: calc(-10px + 25%); float: left; margin: 0 5px;">
                  <img src="https://cdn.discordapp.com/attachments/509492892054585384/509978808804179978/https3A2F2Fs3.png" style="margin-top:250px; width: 75%;"></img>
                </div>
            </div>
        </div>
    </body>
