                ...
                $.ajax({
                    ...
                    success:function(response) {
                        ...
                        for (i = 0; i < obj.length; i++) {
                            ...
                            $("#usersTableBody").html($("#usersTableBody").html() + '<tr><td>' + obj[i].username + '</td><td>' + level + '</td><td><button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#editUserModal" onclick="editUser(' + "'" + obj[i].uuid + "'" + ');">Edit</button><button style="margin-left:5px;" class="btn btn-danger btn-sm" onclick="deleteUser(' + "'" + obj[i].uuid + "'" + ');">Delete</button></td></tr>');
                        }
                    },
                    error:function(){
